    ...
    <div id={styles.loginWrapper}>
      <section id={styles.loginSection}>
        ...
        {/* <form > */}
          ...
          <div id={styles.loginSectionButtonRow} className={styles.loginSectionRows}>
            <button id={styles.loginButtonRegister} className={styles.loginButton} onClick={e => registerHandler(e)}>Register</button>
            <button id={styles.loginButtonLogin} className={styles.loginButton} onClick={(e) => loginHandler(e)}>Login</button>
          </div>
